...
openai.api_key = ""  # Set your key here or from environment
                ...
                if file_type == 'xlsx':
                    ...
                    # Process Excel file and get converted code
                        ...
                        for sheet_name, converted_code in excel_converted_codes.items():
                            ...
                            if generate_tests:
                                    unit_test_code = generate_unit_test(excel_converted_codes, language)
                                    if unit_test_code:
...
def app():
    ...
    # Provide download link for the output zip file
    if st.session_state.converted_files:
        st.download_button("Download Converted Files", data=st.session_state.converted_files, file_name="converted_files.zip", mime="application/zip")
